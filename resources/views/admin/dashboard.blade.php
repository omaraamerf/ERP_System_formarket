    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Manage Goods</h5>
                        <a href="{{ route('goods.index') }}" class="btn btn-primary">View Goods</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('inventories.index') }}" class="btn btn-primary">View Expenses</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('accountant.dashboard') }}" class="btn btn-primary">View Reports</a>
                    </div>
                </div>
            </div>
        </div>
